...
export const INITIAL_GUESTS: Guest[] = [
  { id: 'g1', firstName: 'Jean-Pierre', lastName: 'Martin', category: 'famille-moi', rsvp: 'confirmed', hasPlusOne: false, plusOneName: '', kids: [{ id: 'g1-k1', name: 'Zoé', age: 9 }, { id: 'g1-k2', name: 'Tom', age: 6 }], dietary: '', events: ['ceremony', 'dinner'], transport: 'voiture', notes: '' },
  { id: 'g2', firstName: 'Catherine', lastName: 'Martin', category: 'famille-moi', rsvp: 'confirmed', hasPlusOne: false, plusOneName: '', kids: [], dietary: 'Végétarienne', events: ['ceremony', 'dinner'], transport: 'voiture', notes: 'Marraine du marié' },
  { id: 'g3', firstName: 'Sophie', lastName: 'Lefebvre', category: 'temoins', rsvp: 'confirmed', hasPlusOne: true, plusOneName: 'Marc Lefebvre', kids: [], dietary: '', events: ['rehearsal', 'ceremony', 'dinner'], transport: 'train', notes: 'Témoin principale' },
  { id: 'g4', firstName: 'Hugo', lastName: 'Bernard', category: 'amis', rsvp: 'confirmed', hasPlusOne: true, plusOneName: 'Lucie Bernard', kids: [{ id: 'g4-k1', name: 'Noé', age: 4 }], dietary: '', events: ['ceremony', 'dinner'], transport: 'voiture', notes: '' },
  { id: 'g5', firstName: 'Isabelle', lastName: 'Rousseau', category: 'famille-elle', rsvp: 'pending', hasPlusOne: false, plusOneName: '', kids: [], dietary: 'Sans gluten', events: ['ceremony', 'dinner'], transport: '', notes: '' },
  { id: 'g6', firstName: 'Thomas', lastName: 'Petit', category: 'amis', rsvp: 'pending', hasPlusOne: true, plusOneName: '', kids: [], dietary: '', events: ['dinner'], transport: 'voiture', notes: '' },
  { id: 'g7', firstName: 'Marguerite', lastName: 'Dubois', category: 'famille-elle', rsvp: 'confirmed', hasPlusOne: false, plusOneName: '', kids: [], dietary: '', events: ['ceremony', 'dinner'], transport: 'avion', notes: 'Grand-mère' },
  { id: 'g8', firstName: 'Antoine', lastName: 'Moreau', category: 'temoins', rsvp: 'confirmed', hasPlusOne: false, plusOneName: '', kids: [], dietary: '', events: ['rehearsal', 'ceremony', 'dinner'], transport: 'voiture', notes: 'Témoin du marié' },
  { id: 'g9', firstName: 'Claire', lastName: 'Simon', category: 'amis', rsvp: 'declined', hasPlusOne: false, plusOneName: '', kids: [], dietary: '', events: [], transport: '', notes: 'Ne peut pas venir' },
  { id: 'g10', firstName: 'Pierre', lastName: 'Laurent', category: 'famille-moi', rsvp: 'confirmed', hasPlusOne: true, plusOneName: 'Anne Laurent', kids: [{ id: 'g10-k1', name: 'Emma', age: 12 }], dietary: '', events: ['ceremony', 'dinner'], transport: 'voiture', notes: '' },
  { id: 'g11', firstName: 'Élise', lastName: 'Fontaine', category: 'amis', rsvp: 'confirmed', hasPlusOne: false, plusOneName: '', kids: [], dietary: '', events: ['ceremony', 'dinner'], transport: 'train', notes: '' },
  { id: 'g12', firstName: 'Raphaël', lastName: 'Girard', category: 'famille-elle', rsvp: 'pending', hasPlusOne: true, plusOneName: 'Nina Girard', kids: [{ id: 'g12-k1', name: 'Lola', age: 7 }], dietary: '', events: ['ceremony', 'dinner'], transport: 'voiture', notes: '' },
];
...
export const INITIAL_TABLES: Table[] = [
  { id: 't1', name: 'Table des Mariés', seats: 10, guestIds: [] },
  { id: 't2', name: 'Famille', seats: 14, guestIds: ['g1', 'g2', 'g10', 'g7'] },
  { id: 't3', name: 'Amis Proches', seats: 12, guestIds: ['g3', 'g4', 'g8', 'g11'] },
  { id: 't4', name: 'Table 4', seats: 12, guestIds: ['g5', 'g6'] },
];
