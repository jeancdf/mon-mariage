...
export const INITIAL_GUESTS: Guest[] = [
  { id: 'g1', firstName: 'Jean-Pierre', lastName: 'Martin', category: 'famille-moi', rsvp: 'confirmed', hasPlusOne: false, plusOneName: '', kids: [{ name: 'Zoé', age: 9 }, { name: 'Tom', age: 6 }], dietary: '', events: ['ceremony', 'dinner'], transport: 'voiture', notes: '' },
  ...
  { id: 'g4', firstName: 'Hugo', lastName: 'Bernard', category: 'amis', rsvp: 'confirmed', hasPlusOne: true, plusOneName: 'Lucie Bernard', kids: [{ name: 'Noé', age: 4 }], dietary: '', events: ['ceremony', 'dinner'], transport: 'voiture', notes: '' },
  ...
  { id: 'g10', firstName: 'Pierre', lastName: 'Laurent', category: 'famille-moi', rsvp: 'confirmed', hasPlusOne: true, plusOneName: 'Anne Laurent', kids: [{ name: 'Emma', age: 12 }], dietary: '', events: ['ceremony', 'dinner'], transport: 'voiture', notes: '' },
  ...
  { id: 'g12', firstName: 'Raphaël', lastName: 'Girard', category: 'famille-elle', rsvp: 'pending', hasPlusOne: true, plusOneName: 'Nina Girard', kids: [{ name: 'Lola', age: 7 }], dietary: '', events: ['ceremony', 'dinner'], transport: 'voiture', notes: '' },
];
